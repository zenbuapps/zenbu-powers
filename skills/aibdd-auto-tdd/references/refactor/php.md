# refactor — PHP WordPress Integration Test

> 主 SKILL.md 已涵蓋：trigger 辨識、兩階段工作流（Phase A 測試碼 → Phase B 生產碼）的通用結構、共用安全規則 R1-R7 框架。本檔僅提供 PHP 特化內容。

PHP IT Stage 4：在全綠燈保護下，以**小步驟、連續測試**的方式改善程式碼品質。**嚴格遵守** `references/code-quality/php.md` 規範。
...
3. 已載入 `references/code-quality/php.md` 規範
...
> 詳細規範請載入 `references/code-quality/php.md`。
...
### Phase B（生產碼）
- [ ] 符合 `references/code-quality/php.md` 所有檢查項
- [ ] SOLID 合規
- [ ] 型別宣告完整
