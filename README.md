...
| `/refine-v4` | Refine v4 CRUD meta-framework 完整技術參考 |
| `/refine-v5` | Refine v5 headless meta-framework 完整技術參考 |
| `/antd-v5` | Ant Design v5 元件庫 API 參考 |
| `/antd-v6` | Ant Design v6 元件庫 API 參考 |
...
│   ├── copy-sets.mjs          # 偵測技術棧、複製 skill-set / agent-set 進專案 .claude/
